<template>
  <div>
    ...
    >
        ...
        <v-toolbar flat>
          ...
          <v-dialog v-model="dialog" max-width="500px">
            <template v-slot:activator="{ on, attrs }">
              <v-btn color="primary" dark class="mb-2" v-bind="attrs" v-on="on" @click="getTag">
                New Item
              </v-btn>
            </template>
            <v-card>
              <v-card-title>
                <span class="headline">dd</span>
              </v-card-title>
      ...
      <v-btn color="primary" type="filled" @click="getTag">Test get tag</v-btn>
    </v-data-table>
  </div>
</template>
